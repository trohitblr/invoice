...
/**
 * REST controller for managing {@link com.retailer.invoice.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Address> result = addressRepository
            ...
            .map(existingAddress -> {
                ...
                if (address.getShippingAddress() != null) {
                    existingAddress.setShippingAddress(address.getShippingAddress());
                }
                if (address.getBillingAddress() != null) {
                    existingAddress.setBillingAddress(address.getBillingAddress());
                }
                if (address.getHomeAddress() != null) {
                    existingAddress.setHomeAddress(address.getHomeAddress());
                }
                if (address.getOfficeAddress() != null) {
                    existingAddress.setOfficeAddress(address.getOfficeAddress());
                }
                if (address.getCreatedOn() != null) {
                    existingAddress.setCreatedOn(address.getCreatedOn());
                }
                if (address.getUpdatedOn() != null) {
                    existingAddress.setUpdatedOn(address.getUpdatedOn());
                }
