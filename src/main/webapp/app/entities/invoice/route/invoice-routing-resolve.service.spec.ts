...
describe('Invoice routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IInvoice returned by find', () => {
      // GIVEN
      service.find = jest.fn(invoiceId => of(new HttpResponse({ body: { invoiceId } })));
      mockActivatedRouteSnapshot.params = { invoiceId: 123 };
      ...
      expect(resultInvoice).toEqual({ invoiceId: 123 });
    });
