...
describe('Customer Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Address query and add missing value', () => {
      const customer: ICustomer = { customerId: 456 };
      const invoiceAddress: IAddress = { id: 4768 };
      customer.invoiceAddress = invoiceAddress;
      const billingAddress: IAddress = { id: 14234 };
      customer.billingAddress = billingAddress;

      const addressCollection: IAddress[] = [{ id: 38010 }];
    ...
    it('Should update editForm', () => {
      const customer: ICustomer = { customerId: 456 };
      const invoiceAddress: IAddress = { id: 72822 };
      customer.invoiceAddress = invoiceAddress;
      const billingAddress: IAddress = { id: 95799 };
      customer.billingAddress = billingAddress;
  ...
  describe('save', () => {
    ...
    it('Should call create service on save for new entity', () => {
      ...
      const saveSubject = new Subject<HttpResponse<ICustomer>>();
      const customer = { customerId: 123 };
      jest.spyOn(customerFormService, 'getCustomer').mockReturnValue({ customerId: null });
