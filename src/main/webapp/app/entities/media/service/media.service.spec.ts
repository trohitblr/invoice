...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../media.test-samples';

import { MediaService } from './media.service';

const requireRestSample: IMedia = {
