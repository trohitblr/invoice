...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "C%6Q'@\\SSS";
    private static final String UPDATED_EMAIL = "Z+E1V@\\SSS";
    ...
    void putExistingCustomer() throws Exception {
        ...
        restCustomerMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedCustomer.getCustomerId())
    ...
    void putNonExistingCustomer() throws Exception {
        ...
        restCustomerMockMvc
            .perform(
                put(ENTITY_API_URL_ID, customer.getCustomerId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.email(UPDATED_EMAIL).createdOn(UPDATED_CREATED_ON).updatedBy(UPDATED_UPDATED_BY);
    ...
    void patchNonExistingCustomer() throws Exception {
        ...
        restCustomerMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, customer.getCustomerId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(customer))
            )
            .andExpect(status().isBadRequest());
